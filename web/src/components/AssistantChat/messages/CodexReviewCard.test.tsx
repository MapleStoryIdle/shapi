...
describe('CodexReviewCard', () => {
    it('renders overall review details and finding locations', () => {
        ...
        expect(screen.getByText('Remove retained sessions when sockets disconnect')).toBeInTheDocument()
        expect(screen.queryByText('[P2] Remove retained sessions when sockets disconnect')).not.toBeInTheDocument()
