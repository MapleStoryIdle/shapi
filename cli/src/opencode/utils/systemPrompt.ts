...
export const TITLE_INSTRUCTION = trimIdent(`
    ...
    When you create or find a local image file that the user should see, call the tool "hapi_display_image" with the image path so SHAPI can show it inline.
...
/**
 * Instruction prepended to OpenCode prompts while SHAPI plan mode is active.
 */
