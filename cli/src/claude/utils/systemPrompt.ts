...
const BASE_SYSTEM_PROMPT = (() => trimIdent(`
    ...
    When you create or find a local image file that the user should see, call the tool "mcp__hapi__display_image" with the image path so SHAPI can show it inline.
...
const CO_AUTHORED_CREDITS = (() => trimIdent(`
    When making commit messages, you SHOULD also give credit to SHAPI like so:

    <main commit message>

    via [SHAPI](https://github.com/MapleStoryIdle/shapi)

    Co-Authored-By: SHAPI <noreply@github.com>
`))();
